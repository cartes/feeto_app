...
use App\Http\Requests\TenantAcquisitionReportRequest;
...
class AcquisitionReportController extends Controller
{
    ...
    public function index(TenantAcquisitionReportRequest $request): Response
    {
        ...
        return Inertia::render('Reports/Acquisition', $this->reportDataService->acquisition($request->validated()));
    }
}
